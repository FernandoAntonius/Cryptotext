...
class _HomeScreen extends State<HomeScreen> {
  ...
  String? _errorText;
  bool _isDecryptedButtonEnabled = false;

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('CryptoText')),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            ElevatedButton(
              onPressed: _isDecryptedButtonEnabled && _encryptedText.isNotEmpty
                  ? () {
  ...
  void _onTextChanged(String text) {
    setState(() {
      _isDecryptedButtonEnabled = text.isNotEmpty;
      _encryptedText = '';
      _decryptedText = '';
      _errorText = null;
    });
  ...
  void _encryptText(String text) {
    try {
      ...
      print('Error encrypting text: $e, stackStrace: $stackTrace');
    }
  }
